...
const mockAgent = {
    ...
    totalSurveys: 45,
    approvedSurveys: 38,
    // MOCK: Agent QR code string - will be generated by backend in production
    agentQrCode: 'AGENT-TVRI-2026-001-SUDRAJAT',
};
            ...
            <div className="space-y-6">
                ...
                <div className={`rounded-xl p-4 ${isDark ? 'bg-[#0d1414] border border-emerald-900/30' : 'bg-white border border-gray-200'}`}>
                    <div className="flex items-center gap-2 mb-3">
                        <QrCode className={`w-4 h-4 ${isDark ? 'text-emerald-400' : 'text-teal-600'}`} />
                    ...
                    <div className="flex justify-center">
                        <div className={`p-3 rounded-xl ${isDark ? 'bg-white' : 'bg-gray-50'}`}>
                            <img 
                                src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=${encodeURIComponent(mockAgent.agentQrCode)}`}
                                alt="QR Code Agen"
                                className="w-44 h-44"
                            />
                        </div>
